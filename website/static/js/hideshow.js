function setupTabs() {
    ...
    if (initialActiveTab) {
        // Set the initial active tab directly without triggering a click event
        const tabNumber = initialActiveTab.dataset.forTab;
        document.querySelectorAll('.content-container').forEach(container => {
            container.classList.remove('content-container--active');
        });
        ...
        initialActiveTab.classList.add('menu-link--active');
    }
}
